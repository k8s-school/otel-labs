...
Le quatrième panel, **« Latence p95 »**, arrive avec l'import : vous ne l'avez pas écrit. Ce qu'il mesure exactement, et le piège qu'évite son filtre `span_kind`, sont le sujet du [Lab 4.2]({{% relref "43-otel-spanmetrics" %}}).
